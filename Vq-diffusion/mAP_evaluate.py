...
class mAPData(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if  self.split == 'gen':   
            ...
            img_path = img_path.replace('_128_','_256_').replace('256_sentence','')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', dest='data_dir', type=str, default='/content/drive/MyDrive/img_npy')    
    ...
    print("total ground loader loop  ",len(ground_imgs))
    ...
    print("total gen loader loop",len(gen_imgs))
