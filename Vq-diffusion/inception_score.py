...
def inception_score(imgs, args, cuda=True, batch_size=32, resize=False, splits=1):
    ...
    #inception_model.load_state_dict(torch.load('/content/drive/MyDrive/project/StackGAN-inception-model/inception_finetuned_models/birds_valid299/model.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', dest='data_dir', type=str, default='RESULT/epoch600')    
    parser.add_argument('--exp_dir', dest='exp_dir', type=str, default='OUTPUT/cub200_train')   
   ...
   # for epoch_name in epoch_names:
    epoch = 600#int(epoch_name[5:])
    print("evaluate epoch: ",args.data_dir)
    path = root_path #os.path.join(root_path,epoch_name)    
