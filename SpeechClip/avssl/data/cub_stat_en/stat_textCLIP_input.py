...
DATASET_DIR = "/content/drive/MyDrive/project/SpeechCLIP_CUB/SpeechClip/data/CUB_200_2011"

# TXT_FILE = "Flickr8k.lemma.token.txt"
TXT_FILE = "CUB.token.txt"
...
if __name__ == "__main__":
    ...
    tokens = clip.tokenize(texts=captions, context_length=256, truncate=False)
